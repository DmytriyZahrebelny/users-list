...
export const BronzeMedalIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" id="icon" viewBox="0 0 337.98 638.46">
    <defs>
      <style>
        {
    ...
    />
    <polygon className="cls-10" points="87.83 0 251.26 0 213.44 81.17 125.65 81.17 87.83 0" />
    <polygon className="cls-11" points="213.44 81.17 251.26 0 219.57 0 213.44 81.17" />
  </svg>
);
